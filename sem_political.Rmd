...
As these are nested models, we can test the difference between them with a likelihood ratio test, shown in Table \ref{tab:collapse-compare}. The models are significantly different, indicating that the two-factor model is not sufficient to represent the latent structure.
